...
function MPDTestFullPath2Levels(path,folderName,fromIndex,toIndex,DestinationPath)
 %   fullPath = path+'\'+folderName
    ...
    %  Level 2
        ...
        assignin('base', 'Regions', Regions);
           ...
           [AverageCatName,CateNames,Regions] = testImgMultiPlatesVsNonPlatesLevelTwo(path)
